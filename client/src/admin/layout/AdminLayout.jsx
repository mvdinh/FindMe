...
import AdminNavbarPanel from '../components/AdminNavbar';
import { lockHrBodyScroll, unlockHrBodyScroll } from '../adminBodyScrollLock';
  ...
  return (
    <div className="flex h-[100dvh] min-h-0 flex-col overflow-hidden bg-background md:flex-row md:h-screen transition-colors duration-300">
      ...
      <Sheet open={mobileDrawerOpen} onOpenChange={setMobileDrawerOpen}>
        ...
        >
          <AdminNavbarPanel onNavigate={() => setMobileDrawerOpen(false)} />
        </SheetContent>
      </Sheet>
    </div>
  );
