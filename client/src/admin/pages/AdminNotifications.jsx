...
const AdminNotifications = () => {
  ...
  const renderIcon = (iconType, colorClass) => {
    ...
    switch (iconType) {
      ...
      case 'bell':
        return (
          <svg className="w-5 h-5 text-red-500 dark:text-red-400 stroke-current" fill="none" viewBox="0 0 24 24">
      ...
      <div className={ADMIN_PAGE}>
        <div className={ADMIN_PAGE_HEADER}>
          <div className="min-w-0 flex-1">
            <h1 className={ADMIN_H1}>Thông báo quản trị</h1>
            <p className={ADMIN_SUBTITLE}>Theo dõi hoạt động hệ thống và cảnh báo quản trị — cùng giao diện thông báo HR.</p>
          </div>
          ...
          <CardHeader className="border-b p-4">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                <Checkbox
                  id="admin-notify-select-all"
                  checked={selectedNotifications.length === notifications.length && notifications.length > 0}
                  onCheckedChange={() => selectAllNotifications()}
                />
                <label htmlFor="admin-notify-select-all" className="cursor-pointer text-sm font-['Roboto'] text-foreground">
              ...
              notifications.map(notification => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg transition-colors ${colors.accent} ${n.read ? 'bg-gray-100 dark:bg-gray-700' : 'bg-red-100/80 dark:bg-red-950/40'}`}
                    >
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="mb-1 flex items-center space-x-2">
                            ...
                            {!n.read && (
                              <div
                                className="h-2 w-2 shrink-0 rounded-full bg-primary ring-2 ring-primary/25"
                                aria-hidden
                              />
                            )}
                          </div>
