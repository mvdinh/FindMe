...
import ApplicantNavbarPanel from '../components/ApplicantNavbar';
import { lockHrBodyScroll, unlockHrBodyScroll } from '../applicantBodyScrollLock';
  ...
  return (
    <div className="flex h-[100dvh] min-h-0 flex-col overflow-hidden bg-background md:flex-row md:h-screen transition-colors duration-300">
      ...
      <Sheet open={mobileDrawerOpen} onOpenChange={setMobileDrawerOpen}>
        ...
        >
          <ApplicantNavbarPanel onNavigate={() => setMobileDrawerOpen(false)} />
        </SheetContent>
      </Sheet>
    </div>
  );
