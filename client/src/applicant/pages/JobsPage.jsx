...
const JobsPage = () => {
  ...
  const fetchJobs = useCallback(
    async (useCache = true) => {
      try {
        setLoading(true);
        setError(null);
        // On the home page, we don't query with hero search keyword or location
  ...
  }, [filters.workType, filters.jobType, filters.experience]);
  useEffect(() => {
    fetchJobs();
  }, [
    filters.workType,
      ...
      <div className="relative bg-gradient-to-r from-red-800 to-red-600 pt-32 pb-24 mb-12">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-2 text-sm text-red-100">
            <span className="font-medium mr-2 mt-1">Gợi ý:</span>
            {[
              "AI Engineer",
              "Data Scientist",
