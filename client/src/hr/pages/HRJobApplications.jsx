  ...
  const fetchApplicationsPage = useCallback(
    async (page = 1) => {
      ...
      try {
        ...
        const appsResponse = await makeJsonRequest(`/api/hr/jobs/${jobId}/applications?${qs}`);
    ...
    return (
      <HRLayout>
        <div className={HR_PAGE}>
          ...
          <Button variant="outline" className="mt-4 font-['Roboto']" onClick={() => navigate('/hr/jobs')}>
        ...
        <div className={HR_PAGE_HEADER}>
          ...
          <div className="flex w-full flex-col gap-2 min-[480px]:flex-row min-[480px]:flex-wrap sm:w-auto sm:justify-end">
            <Button variant="outline" className="min-h-11 w-full touch-manipulation font-['Roboto'] min-[480px]:w-auto" asChild disabled={busy}>
              <Link to={`/hr/jobs/${jobId}/edit`} tabIndex={busy ? -1 : undefined} aria-hidden={busy} className="inline-flex items-center gap-2">
                <Pencil className="size-4 shrink-0" />
                Sửa tin
              </Link>
            </Button>
            <Button className="min-h-11 w-full touch-manipulation font-['Roboto'] min-[480px]:w-auto" onClick={() => navigate('/hr/jobs')} disabled={busy}>
          ...
          <Card className="mt-4 shadow-sm sm:mt-6">
            <CardContent className="grid grid-cols-1 gap-4 pt-6 text-sm md:grid-cols-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <Badge variant="outline" className={cn('font-normal', hrStatusBadgeClass(job.status))}>
        ...
        <div className="mb-4 grid grid-cols-2 gap-3 sm:mb-6 md:grid-cols-4 md:gap-4">
          ...
          <Card className="shadow-sm">
            <CardContent className="pt-6">
              ...
              <p className="font-['Roboto'] text-sm text-muted-foreground">Đang xem xét</p>
            </CardContent>
          </Card>
          <Card className="shadow-sm">
            <CardContent className="pt-6">
            ...
            <CardContent className="flex flex-wrap items-center justify-between gap-3 pt-6">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Button size="sm" className="font-['Roboto']" asChild disabled={busy}>
                  <Link to={`/hr/applications?jobId=${jobId}`} tabIndex={busy ? -1 : undefined} aria-hidden={busy}>
                    Xem nâng cao
                  </Link>
                </Button>
              </div>
            ...
            <CardContent className="py-12 text-center">
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-3">
                <Button variant="outline" asChild disabled={busy}>
                  <Link to={`/hr/jobs/${jobId}/edit`} tabIndex={busy ? -1 : undefined} aria-hidden={busy}>
                    Chỉnh sửa tin
                  </Link>
                </Button>
                <Button asChild disabled={busy}>
                  <Link to="/hr/jobs" tabIndex={busy ? -1 : undefined} aria-hidden={busy}>
