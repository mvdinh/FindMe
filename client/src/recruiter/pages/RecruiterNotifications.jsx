...
const RecruiterNotifications = () => {
  ...
  const deleteSelectedNotifications = async () => {
    try {
      ...
      console.error('Recruiter bulk delete failed', e);
  ...
  const confirmDeleteSingleNotify = async () => {
    ...
    try {
      ...
      console.error('Recruiter single delete failed', err);
          ...
          <CardHeader className="border-b p-4">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                <Checkbox
                  id="recruiter-notify-select-all"
                  checked={selectedNotifications.length === notifications.length && notifications.length > 0}
                  onCheckedChange={() => selectAllNotifications()}
                />
                <label htmlFor="recruiter-notify-select-all" className="cursor-pointer text-sm font-['Roboto'] text-foreground">
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
                            ...
                            <Link
                              data-notify-control
                              to={`/recruiter/notifications/${n._id}`}
                              onClick={e => {
                                e.stopPropagation();
