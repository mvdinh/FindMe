...
/** @see ./recruiterTheme.js — token theme (shadcn) */
...
export const HR_FILTER_CHIPS = cn(
  'recruiter-scroll-x flex gap-2 overflow-x-auto pb-1.5 -mx-1 px-1 sm:mx-0 sm:flex-wrap sm:overflow-visible sm:pb-0'
);
